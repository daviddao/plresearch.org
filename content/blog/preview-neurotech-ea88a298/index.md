...
If you are working on neural interfaces, neural foundation models, connectomics, emulation, or the infrastructure and governance around them, we would love to hear from you: [research@protocol.ai](mailto:research@protocol.ai).

We invite you to explore the [projects and publications already contributing to this vision](/areas/neurotech/). Follow PL R&D and Protocol Labs for future publications, field maps, convenings, and opportunities to participate in the ecosystem as it grows.
